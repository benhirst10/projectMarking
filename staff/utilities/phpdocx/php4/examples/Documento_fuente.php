<?php
  ...
  $objDocx->fAddHeader('Cabecera del documento');
  $arrParamsText = array(
    'b' => 'single',
    'color' => 'FF0000',
    'jc' => 'center',
  ...
  $objDocx->fAddText('Introducción', $arrParamsText);
  $arrParamsText = array(
    'jc' => 'both',
  );
...
derit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cpidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', $arrParamsText);
  ...
  $objDocx->fAddText('La formula resultante de este texto es:', $arrParamsText);
  $objDocx->fAddMathDocx('../docx/math.docx');
  $objDocx->fAddLink('Ver más información', 'http://es.wikipedia.org');
  $objDocx->fAddBreak();
  $objDocx->fAddText('Lista de autores participantes: ');
  $arrDatsList = array(
    'Lorem',
    'Ipsum',
    'Dolor',
  ...
  $objDocx->fAddFooter('Pié del documento');
  $arrParamsPage = array(
    'top' => 4000,
    'bottom' => 4000,
    'right' => 4000,
  ...
  $objDocx->fAddTitle('Lorem ipsum dolor sit amet.', $arrParamsText);$arrParamsText = array(
	'val' => 2, 
    'u' => 'double',
    'jc' => 'right'
  );
 ...
 $objDocx->fAddGraphic($arrArgs);
  ...
  $objDocx->fCreateDocx('document_full_fuente', $arrParamsPage);
?>