<?php
class degreeabreviations_model extends Model {

    var $degreeAbreviationsXpath;   
    var $degreeAbreviationsXMLFile='../common/xml/degreeAbreviations.xml';
    

    function degreeabreviations_model()
    {
    
    	// This function initialies the dom xpath so that it can be used for more quering of degree abreviations. 
