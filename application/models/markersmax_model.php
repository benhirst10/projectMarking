<?php
class markersmax_model extends Model {

    var $markersMaxXpath;
    var $markersMaxXMLFile='../staff/generated/xml/markersMax.xml';
    
    function markersmax_model()
    {
	// This function initialies the dom xpath so that it can be used for more quering of markers maximums. 
